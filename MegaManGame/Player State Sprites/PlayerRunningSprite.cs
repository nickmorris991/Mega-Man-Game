...
{
    public class PlayerRunningSprite : ISprite
    {
        ...
        public PlayerRunningSprite(Texture2D texture, Vector2 PrintLocation, bool reversed)
        {
            ...
            Texture = texture;
            SpriteHorizontalSize = 24;
            SpriteVerticalSize = 24;
            
            RunningFramesHorizontalLocation[0] = 76;
            RunningFramesHorizontalLocation[1] = 109;
            RunningFramesHorizontalLocation[2] = 134;
            RunningFramesVerticalLocation = 9;
            ToSlowDownFPS = 0;
            Delay = 17;

            currentRectangle= new Rectangle(RunningFramesHorizontalLocation[0], RunningFramesVerticalLocation, 32, SpriteVerticalSize);
        }
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 location)
        {
            ...
            {
                case 0:
                    SourceRectangle = new Rectangle(RunningFramesHorizontalLocation[0], RunningFramesVerticalLocation, 32, SpriteVerticalSize);
                    break;
                case 1:
