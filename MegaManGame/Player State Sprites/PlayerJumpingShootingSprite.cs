...
{
    public class PlayerJumpingShootingSprite : ISprite
    {
        ...
        public PlayerJumpingShootingSprite(Texture2D texture, Vector2 PrintLocation, bool reversed)
        {
            Texture = texture;
            Location = PrintLocation;
            Reversed = reversed;

            HorizontalCoordinate = 424;
